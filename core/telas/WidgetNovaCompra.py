...
class WidgetNovaCompra(QtWidgets.QWidget):
    """Widget que deve aparecer quando escolhido adicionar compra na tela inicial,
    ...
    def __init__(self, form):
        ...
        self.Form = form
        self.Form.setObjectName("NovaCompra")
        self.Form.resize(640, 480)
        self.formLayoutWidget = QtWidgets.QWidget(self.Form)
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 10, 621, 461))
        ...
        self.lbl_fornecedor = QtWidgets.QLabel(self.formLayoutWidget)
        self.lbl_fornecedor.setObjectName("lbl_fornecedor")
        self.horizontalLayout_10.addWidget(self.lbl_fornecedor)
        self.txt_fornecedor = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.txt_fornecedor.setObjectName("txt_fornecedor")
        self.horizontalLayout_10.addWidget(self.txt_fornecedor)
        self.verticalLayout_7.addLayout(self.horizontalLayout_10)
        self.formLayout.setLayout(0, QtWidgets.QFormLayout.FieldRole, self.verticalLayout_7)
        self.lbl_desc_compra = QtWidgets.QLabel(self.formLayoutWidget)
        self.lbl_desc_compra.setObjectName("lbl_desc_compra")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lbl_desc_compra)
        self.txt_desc_compra = QtWidgets.QTextEdit(self.formLayoutWidget)
        self.txt_desc_compra.setInputMethodHints(QtCore.Qt.ImhDigitsOnly)
        self.txt_desc_compra.setObjectName("txt_desc_compra")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.txt_desc_compra)
        ...
        self.lbl_valor_compra = QtWidgets.QLabel(self.formLayoutWidget)
        self.lbl_valor_compra.setObjectName("lbl_valor_compra")
        self.horizontalLayout_9.addWidget(self.lbl_valor_compra)
    ...
    def retranslate_ui(self, form):
        ...
        self.Form.setWindowTitle(_translate("Form", "NovaCompra"))
        self.lbl_fornecedor.setText(_translate("Form", "Nome do Fornecedor/Loja: "))
        self.lbl_desc_compra.setText(_translate("Form", "Descrição da compra:"))
        self.lbl_valor_compra.setText(_translate("Form", "Valor da Compra: "))
        self.lbl_reais.setText(_translate("Form", "Reais"))
        self.lbl_primeira_parcela.setText(_translate("Form", "Data da primeira parcela (ou da compra para Débito): "))
        self.lbl_n_parcelas.setText(_translate("Form", "Nº de Parcelas: "))
        self.lbl_aviso_pgmt.setText(_translate("Form",
                                               "Selecione 0 para Débito/Dinheiro, ou 1 para no credito sem parcelas."))
